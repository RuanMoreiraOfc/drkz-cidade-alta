var ye=Object.defineProperty,ve=Object.defineProperties;var Ce=Object.getOwnPropertyDescriptors;var K=Object.getOwnPropertySymbols;var se=Object.prototype.hasOwnProperty,le=Object.prototype.propertyIsEnumerable;var oe=(t,a,r)=>a in t?ye(t,a,{enumerable:!0,configurable:!0,writable:!0,value:r}):t[a]=r,f=(t,a)=>{for(var r in a||(a={}))se.call(a,r)&&oe(t,r,a[r]);if(K)for(var r of K(a))le.call(a,r)&&oe(t,r,a[r]);return t},F=(t,a)=>ve(t,Ce(a));var V=(t,a)=>{var r={};for(var l in t)se.call(t,l)&&a.indexOf(l)<0&&(r[l]=t[l]);if(t!=null&&K)for(var l of K(t))a.indexOf(l)<0&&le.call(t,l)&&(r[l]=t[l]);return r};import{W as Ee,c as we,a as Fe,b as re,u as ae,j as e,N as te,s as n,d as H,e as o,H as G,f as De,r as d,F as Se,g as $e,h as Ae,i as Le,L as pe,k as ke,B as Te,R as Ne,l as P,m as Re,n as Pe,P as Be}from"./vendor.dced31d7.js";const Me=function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))l(i);new MutationObserver(i=>{for(const c of i)if(c.type==="childList")for(const h of c.addedNodes)h.tagName==="LINK"&&h.rel==="modulepreload"&&l(h)}).observe(document,{childList:!0,subtree:!0});function r(i){const c={};return i.integrity&&(c.integrity=i.integrity),i.referrerpolicy&&(c.referrerPolicy=i.referrerpolicy),i.crossorigin==="use-credentials"?c.credentials="include":i.crossorigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function l(i){if(i.ep)return;i.ep=!0;const c=r(i);fetch(i.href,c)}};Me();const je=Ee`
  :root {
...
`;var me;const Oe={username:(me=sessionStorage.getItem("username"))!=null?me:null};function Ie(t=Oe,a){switch(a.type){case"LOGIN":{const r=a.payload.username;return sessionStorage.setItem("username",r),{username:r}}case"LOGOUT":return sessionStorage.removeItem("username"),{username:null};default:return t}}var ze=Ve();function Ve(){return we(Fe({session:Ie}))}var B=re(t=>({isAuthenticated:t.session.username!==null}))(Ue);function Ue({isAuthenticated:t,render:a}){const r=ae();if(t===!0&&r.pathname==="/"){const i=r.search.slice(1).replace(/&/g,"=").split("=").reduce((c,h,b,g)=>(b+1)/2===0?F(f({},c),{[g[b+1]]:h}):c,{});return e(te,{to:i.next_redirect||"/dashboard",replace:!0})}return t===!1&&r.pathname!=="/"?e(te,{to:`/?next_redirect=${r.pathname}`,replace:!0}):a}var W=n.div`
   padding: 0 4rem;
